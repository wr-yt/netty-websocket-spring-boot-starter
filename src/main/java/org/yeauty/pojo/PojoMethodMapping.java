...
public class PojoMethodMapping<T> {
    ...
    public PojoMethodMapping(Class<T> pojoClazz, ApplicationContext context, AbstractBeanFactory beanFactory) throws DeploymentException {
